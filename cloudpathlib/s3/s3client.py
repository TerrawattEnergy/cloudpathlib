...
class S3Client(Client):
    ...
    def __init__(
        ...
        Args:
            ...
            boto3_upload_extra_args (Optional[dict]): extra arguments for managing uploading objects s3.
        ...
        self.boto3_upload_extra_args: Final[Dict[str, str]] = boto3_upload_extra_args or {}
    ...
    def _upload_file(self, local_path: Union[str, os.PathLike], cloud_path: S3Path) -> S3Path:
        ...
        extra_args = {}
        if self.boto3_upload_extra_args:
